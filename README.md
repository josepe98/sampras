...
- **Live port monitoring** — watches backend ports (8000–8005) and frontend ports (5173–5178), plus port 8080, and updates the menu bar icon to reflect the current state
- **Process identification** — detects which project is running on each port and displays its name in the menu
- **One-click start/stop/restart** — start, stop, or restart a server by selecting it from a discovered list of local projects
...
- **Auto-start on login** — optional launch agent can be installed to auto-start the everything-app backend at login
